  ...
  return (
    <main>
      ...
      <div className="relative bg-cover bg-center bg-no-repeat"
        ...
        <h1 className="absolute text-white text-5xl max-lg:text-4xl max-md:text-3xl max-sm:text-2xl font-bold top-2/3 z-50 left-1/12 animate-slide-up-to-down">Secondary Faculty</h1>
      </div>

      <section className='text-center text-white bg-[#010130] p-8 mt-12 w-[75%] max-md:w-[95%] mx-auto box-border'>
        <h1 className='text-3xl font-bold mb-4'>
          Meet Secondary School Faculty
        </h1>
        <p>
          Our secondary school faculty is dedicated to providing the best educational experience for our students. With a focus on innovation and excellence, they ensure that our school remains at the forefront of education.
        </p>
      </section>
